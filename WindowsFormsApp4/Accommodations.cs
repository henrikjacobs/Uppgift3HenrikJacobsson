...
namespace WindowsFormsApp4
{
    class Accommodations
    {
        ...
        public Accommodations(int Room_id, int Host_id, string Room_type, string Borough, string Neighbourhood, int Reviews, double Overall_satisfaction, int Accommodates, int Bedrooms, int Price, int Minstay, double Latitude, double Longitude, string Last_modified)
        {
            room_type = Room_type;
            host_id = Host_id;
            room_type = Room_type;
